...
<title>Home</title>
<meta charset="utf-8">
<link rel="stylesheet" href="final.css" media="screen">
...
<style>
	...
	.link a:link{color:#302E38;}
	.link a:visited{color:#302E38;}
	.link a:hover{color:#302E38;}

	.flax{border: 5px solid #EAD186;
		margin-left:215px;
		margin-bottom:15px;
		padding:5px;
	}
...
<body>
	<header>
		<h1> CENSORSHIP IN NORTH KOREA </h1>
	</header> 
	<nav>
		<ul>
			<li><a href="index.html"> Home </a></li>
			<li><a href="about.html"> Overview </a></li>
			<li><a href="mediatype.html"> Media Type</a>
				<ul>
					<li><a href="internet.html">Internet</a></li>
					<li><a href="news.html">News</a></li>
					<li><a href="tvandmovies.html">TV and Movies</a></li>
				</ul>
			</li>
	...
	<main>
		<div id="wrapper">
		<div class="fotorama" data-autoplay="true" data-width="1023px" data-height="578">
		 <div data-img="censorship.jpg" alt="Learn More About Censorship and Propaganda">
			<div class="link">
				<a href="#cap">Learn More About Censorship and Propaganda</a>
			</div>
		</div>
		 <div data-img="internet.jpg" alt="Learn More About Internet Censorship in North Korea">
			<div class="link">
